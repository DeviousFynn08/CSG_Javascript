...
class Kikker {
    constructor(png, celGrootte,raster) {
        ...
        this.stapGrootte = celGrootte/12;
        this.gehaald = false;
        this.raster = raster;
...
if (this.richting === 'right') {
    ...
    this.afbeelding = pngautolinks;
        ...
        this.snelheidAuto = this.baseSnelheid * (this.richting === 'right' ? 1 : -1);
    }
...
class Demospel {
    ...
    nieuwLevel() {
        ...
        this.autos = [];
        const aantalAutos = this.level *3.5+5;
        ...
        const factor = 1 + this.level * 0.25;
